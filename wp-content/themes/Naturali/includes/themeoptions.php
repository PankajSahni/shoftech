...
array( "name" => $themename." Options",
   ...
   array( "name" => "Featured Settings",
           "type" => "section"),
    array( "type" => "open"),


	array(  "name" => "Enable/Disable Featured posts",
			"desc" => "Featured category uses featured images.!",
	...
	array(	"name" => "Number of panels in the gallery",
	...
	array("name" => "Your Facebook Fan Page Url",
			"desc" => "Enter your Facebook URL here (include http://).",
            "id" => $shortname."_fb",
            "std" => "#",
            "type" => "text"),
